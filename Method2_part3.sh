...
$trinitypath --left $5/reads_TCRB_1.fastq --right $5/reads_TCRB_2.fastq --seqType fq --max_memory 10G --output $5/trinity_out_dir
...
$trinitypath --left $5/reads_TCRA_1.fastq --right $5/reads_TCRA_2.fastq --seqType fq --max_memory 10G --output $5/trinity_out_dir
